...
namespace LiteDb.AspNetCore.Identity
{
    public class LiteDbUserStore<TUser> : IUserStore<TUser>, IUserRoleStore<TUser>,
        ...
        where TUser : ApplicationUser, new()
    {
        ...
        {
            return Task.Run(() => { return (IList<string>)user.Roles.ToList(); });
        }
        ...
        {
            return Task.Run(() => (IList<TUser>)_users.Find(u => u.Roles.Contains(roleName)).ToList());
        }
        #endregion
